...
async def embed1(ctx):
    ...
    embed1.add_field(name="🔹 **Discordの利用規約とコミュニティ・ガイドライン、も遵守されます**",value="`🔗`[利用規約](https://discord.com/terms)`🔗`[コミュニティ・ガイドライン](https://discord.com/guidelines)"inline = False) # フィールドを追加。
    embed1.add_field(name="🔹 **トピックを守り、チャンネルを正しく使って下さい**",value="<#899620660937101332>と、トピックに沿ってチャンネルを使用して下さい"inline = False) # フィールドを追加。
